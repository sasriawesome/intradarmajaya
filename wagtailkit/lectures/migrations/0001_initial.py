# Generated by Django 2.2.10 on 2020-02-15 15:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('polymorphic_ctype', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polymorphic_lectures.studentscore_set+', to='contenttypes.ContentType')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('studentscore_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='lectures.StudentScore')),
                ('ori_code', models.CharField(max_length=128, verbose_name='Origin Course Code')),
                ('ori_name', models.CharField(max_length=128, verbose_name='Origin Course Name')),
                ('ori_numeric_score', models.CharField(max_length=128, verbose_name='Origin Numeric Score')),
                ('ori_alphabetic_score', models.CharField(max_length=128, verbose_name='Origin Alphabetic Score')),
            ],
            options={
                'verbose_name': 'Ext Conversion Score',
                'verbose_name_plural': 'Ext Conversion Scores',
            },
            bases=('lectures.studentscore',),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lecture', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='lectures.Lecture', verbose_name='Lecture')),
            ],
            options={
