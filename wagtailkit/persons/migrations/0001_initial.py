    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.CharField(max_length=3, unique=True, verbose_name='Slug')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('export_person', 'Can export Person'), ('import_person', 'Can import Person')),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FNS', 'Finished'), ('ONG', 'Ongoing'), ('UNF', 'Unfinished')], default='FNS', max_length=3, verbose_name='Current status')),
                ('attachment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='wagtaildocs.Document')),
                ('level', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='persons.EducationLevel', verbose_name='Level')),
