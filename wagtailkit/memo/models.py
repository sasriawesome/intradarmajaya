...
class Memo(NumeratorMixin, CreatorModelMixin, KitBaseModel):
    ...
    doc_code = 'IM'
    memo_from = models.ManyToManyField(
        Chairman, related_name='memos_sent',
        verbose_name=_("To"))
    memo_to = models.ManyToManyField(
        Chairman, related_name='memos_received',
        verbose_name=_("To"))
    memo_cc = models.ManyToManyField(
        Chairman, related_name='memo_cc_received',
        verbose_name=_("CC"))
    ...
    attachment = models.ManyToManyField(
        Document, verbose_name=_('Attachment'))
